...
namespace Client.Logic.FaultServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="GetDataFault", Namespace="http://schemas.datacontract.org/2004/07/Server.WebHost")]
    ...
    public interface IFaultService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Client.Logic.FaultServiceReference.GetDataFault), Action="http://tempuri.org/IFaultService/GetDataGetDataFaultFault", Name="GetDataFault", Namespace="http://schemas.datacontract.org/2004/07/Server.WebHost")]
        string GetData();
